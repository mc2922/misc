...
public final class quaternion_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(njord.quaternion_t.class))
            return 0L;
 
        classes.add(njord.quaternion_t.class);
    ...
    public static njord.quaternion_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        njord.quaternion_t o = new njord.quaternion_t();
    ...
    public njord.quaternion_t copy()
    {
        njord.quaternion_t outobj = new njord.quaternion_t();
        outobj.w = this.w;
